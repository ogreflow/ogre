...
/**
 *
 * This class was copied from org.apache.log4j.rolling.TimeBasedRollingPolicy of apache-log4j-extras 1.2.17
 ...
 * @author Curt Arnold
 */
public class NonFinalTimeBasedRollingPolicy extends RollingPolicyBase
   ...
   */
  protected int suffixLength = 0;

  /**
   * Constructs a new instance.
   */
  public NonFinalTimeBasedRollingPolicy() {
  }
  ...
  public static void main(String[] args) {
    ...
    File file0 = new File("/Users/fred/widespace/ws_common/active/server.log");
    File file1 = new File("/Users/fred/widespace/ws_common/archive/server.log.2014-10-31-14-54-02");

    System.out.println("file0 = " + file0.exists());
    System.out.println("file1 = " + file1.exists());

    boolean b = file0.renameTo(file1);
    System.out.println("b = " + b);

  }

  protected static class WsFileRenameAction extends ActionBase {
     ...
     */
    protected final boolean renameEmptyFiles;
    ...
    public static boolean execute(
      ...
      if (renameEmptyFiles || (source.length() > 0)) {
        ...
        //Use a platform-safe version of renaming/moving files
        try {
