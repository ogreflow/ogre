 ...
 */
public class AvroConcatHandler {
    ...
    public AvroConcatHandler(Config theConfig, Set<String> theCliTypes) {
    ...
    public void load(DateHour theFrom, DateHour theTo, boolean theReplace) {
        ...
        for (DateHour anHour : aTimeRange) {
            concatWithRetry(anHour, theReplace, 30);
        }
    }
